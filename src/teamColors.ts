...
export interface TeamColors {
    primary: string;
    secondary: string;
    text: string; // Text color that contrasts well with primary
}

export class TeamColorService {
    // NFL Team Colors
    private static readonly NFL_COLORS: { [key: string]: TeamColors } = {
    ...
    // NBA Team Colors
    private static readonly NBA_COLORS: { [key: string]: TeamColors } = {
    ...
    // MLB Team Colors
    private static readonly MLB_COLORS: { [key: string]: TeamColors } = {
    ...
    // NHL Team Colors
    private static readonly NHL_COLORS: { [key: string]: TeamColors } = {
    ...
    private static readonly PREMIER_LEAGUE_COLORS: { [key: string]: TeamColors } = {
        'ARS': { primary: '#EF0107', secondary: '#023474', text: '#FFFFFF' }, // Arsenal
        'AVL': { primary: '#95BFE5', secondary: '#670E36', text: '#000000' }, // Aston Villa
        ...
        'TOT': { primary: '#132257', secondary: '#FFFFFF', text: '#FFFFFF' }, // Tottenham
        'WHU': { primary: '#7A263A', secondary: '#1BB1E7', text: '#FFFFFF' }, // West Ham
        'WOL': { primary: '#FDB913', secondary: '#231F20', text: '#000000' }  // Wolves
    };

    static getTeamColors(teamAbbreviation: string, sport: 'nfl' | 'nba' | 'mlb' | 'nhl' | 'premierLeague'): TeamColors | undefined {
    ...
    static getDefaultColors(): TeamColors {
        return {
            primary: '#666666',
            secondary: '#CCCCCC',
            text: '#FFFFFF'
